...
class CourtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create court" do
    assert_difference("Court.count") do
      post courts_url, params: { court: { capacity: @court.capacity, location: @court.location, name: @court.name } }
    end
  ...
  test "should update court" do
    patch court_url(@court), params: { court: { capacity: @court.capacity, location: @court.location, name: @court.name } }
